var options = {
    url: {
        get: Language.common.apiurl + "/Log/GetPagingLoginLog",
        delete: "/Log/DeleteLoginLogById"
    },
    table: {
        name: "list",
        primaryKey: "LoginId"
    ...
    layui.use('table', function () {
        ...
        $grid = tableObj.render({
            ...
            cols: [[
                ...
                { field: 'CreateTime', title: "登录时间", width: 120, align: "center" },
                { field: 'CreateUserCode', title: '登录名', width: 150, sort: true },
                { field: 'CreateUserName', title: '名称', width: 100, sort: true },
                { field: 'RemoteIp', title: "登录Id", width: 80 },
                { field: 'RemoteIpAddress', title: "归属地址", width: 120, align: "center" },
                { field: 'LastVisitTime', title: "退出时间", width: 150 },
                { field: 'StandingTime', title: "停留时间(小时)", width: 150 }
            ]],
            limit: 50,
